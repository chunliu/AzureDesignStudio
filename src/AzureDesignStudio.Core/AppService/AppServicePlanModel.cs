...
namespace AzureDesignStudio.Core.AppService
{
    public class AppServicePlanModel : AzureGroupBase
    {
        ...
        public override string ResourceType => "Microsoft.Web/serverfarms";
        public override string ApiVersion => "2021-02-01";
        [Required, DisplayName("OS")]
        public string Kind { get; set; } = "linux";
        [Required, DisplayName("SKU Name")]
        public string SkuName { get; set; } = "P1v2";
        private string tier = "PremiumV2";
        ...
        public string SkuTier 
        {
            ...
            set
            {
                ...
                {
                    tier = value;
                    GroupStyle.BackgroundColor = tier switch
                    {
                        "Dynamic" => "#fff2e8",
